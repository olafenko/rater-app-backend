...
public class CharacterRepository {
    ...
    private void init() {
        ...
        fakeDB.put(79, new CharacterEntity(79, "Mordekaiser", 1000));
        fakeDB.put(80, new CharacterEntity(80, "Morgana", 1000));
        fakeDB.put(81, new CharacterEntity(81, "Nami", 1000));
        fakeDB.put(82, new CharacterEntity(82, "Nasus", 1000));
        fakeDB.put(83, new CharacterEntity(83, "Nautilus", 1000));
        fakeDB.put(84, new CharacterEntity(84, "Neeko", 1000));
        fakeDB.put(85, new CharacterEntity(85, "Nidalee", 1000));
        fakeDB.put(86, new CharacterEntity(86, "Nilah", 1000));
        fakeDB.put(87, new CharacterEntity(87, "Nocturne", 1000));
        fakeDB.put(88, new CharacterEntity(88, "Nunu", 1000));
        fakeDB.put(89, new CharacterEntity(89, "Olaf", 1000));
        fakeDB.put(90, new CharacterEntity(90, "Orianna", 1000));
        fakeDB.put(91, new CharacterEntity(91, "Ornn", 1000));
        fakeDB.put(92, new CharacterEntity(92, "Pantheon", 1000));
        fakeDB.put(93, new CharacterEntity(93, "Poppy", 1000));
        fakeDB.put(94, new CharacterEntity(94, "Pyke", 1000));
        fakeDB.put(95, new CharacterEntity(95, "Qiyana", 1000));
        fakeDB.put(96, new CharacterEntity(96, "Quinn", 1000));
        fakeDB.put(97, new CharacterEntity(97, "Rakan", 1000));
        fakeDB.put(98, new CharacterEntity(98, "Rammus", 1000));
        fakeDB.put(99, new CharacterEntity(99, "RekSai", 1000));
        fakeDB.put(100, new CharacterEntity(100, "Rell", 1000));
        fakeDB.put(101, new CharacterEntity(101, "Renata", 1000));
        fakeDB.put(102, new CharacterEntity(102, "Renekton", 1000));
        fakeDB.put(103, new CharacterEntity(103, "Rengar", 1000));
        fakeDB.put(104, new CharacterEntity(104, "Riven", 1000));
        fakeDB.put(105, new CharacterEntity(105, "Rumble", 1000));
        fakeDB.put(106, new CharacterEntity(106, "Ryze", 1000));
        fakeDB.put(107, new CharacterEntity(107, "Samira", 1000));
        fakeDB.put(108, new CharacterEntity(108, "Sejuani", 1000));
        fakeDB.put(109, new CharacterEntity(109, "Senna", 1000));
        fakeDB.put(110, new CharacterEntity(110, "Seraphine", 1000));
        fakeDB.put(111, new CharacterEntity(111, "Sett", 1000));
        fakeDB.put(112, new CharacterEntity(112, "Shaco", 1000));
        fakeDB.put(113, new CharacterEntity(113, "Shen", 1000));
        fakeDB.put(114, new CharacterEntity(114, "Shyvana", 1000));
        fakeDB.put(115, new CharacterEntity(115, "Singed", 1000));
        fakeDB.put(116, new CharacterEntity(116, "Sion", 1000));
        fakeDB.put(117, new CharacterEntity(117, "Sivir", 1000));
        fakeDB.put(118, new CharacterEntity(118, "Skarner", 1000));
        fakeDB.put(119, new CharacterEntity(119, "Sona", 1000));
        fakeDB.put(120, new CharacterEntity(120, "Soraka", 1000));
        fakeDB.put(121, new CharacterEntity(121, "Swain", 1000));
        fakeDB.put(122, new CharacterEntity(122, "Sylas", 1000));
        fakeDB.put(123, new CharacterEntity(123, "Syndra", 1000));
        fakeDB.put(124, new CharacterEntity(124, "TahmKench", 1000));
        fakeDB.put(125, new CharacterEntity(125, "Taliyah", 1000));
        fakeDB.put(126, new CharacterEntity(126, "Talon", 1000));
        fakeDB.put(127, new CharacterEntity(127, "Taric", 1000));
        fakeDB.put(128, new CharacterEntity(128, "Teemo", 1000));
        fakeDB.put(129, new CharacterEntity(129, "Thresh", 1000));
        fakeDB.put(130, new CharacterEntity(130, "Tristana", 1000));
        fakeDB.put(131, new CharacterEntity(131, "Trundle", 1000));
        fakeDB.put(132, new CharacterEntity(132, "Tryndamere", 1000));
        fakeDB.put(133, new CharacterEntity(133, "TwistedFate", 1000));
        fakeDB.put(134, new CharacterEntity(134, "Twitch", 1000));
        fakeDB.put(135, new CharacterEntity(135, "Udyr", 1000));
        fakeDB.put(136, new CharacterEntity(136, "Urgot", 1000));
        fakeDB.put(137, new CharacterEntity(137, "Varus", 1000));
        fakeDB.put(138, new CharacterEntity(138, "Vayne", 1000));
        fakeDB.put(139, new CharacterEntity(139, "Veigar", 1000));
        fakeDB.put(140, new CharacterEntity(140, "Velkoz", 1000));
        fakeDB.put(141, new CharacterEntity(141, "Vex", 1000));
        fakeDB.put(142, new CharacterEntity(142, "Vi", 1000));
        fakeDB.put(143, new CharacterEntity(143, "Viego", 1000));
        fakeDB.put(144, new CharacterEntity(144, "Viktor", 1000));
        fakeDB.put(145, new CharacterEntity(145, "Vladimir", 1000));
        fakeDB.put(146, new CharacterEntity(146, "Volibear", 1000));
        fakeDB.put(147, new CharacterEntity(147, "Warwick", 1000));
        fakeDB.put(148, new CharacterEntity(148, "Wukong", 1000));
